...
*/
void rango(int *);
void precioMin(int, int *);
void precioMax(int, int *);
void stockMaxim(int, int *);
void calcularInferior(int, int, int *);
...
void precioMin(int precioMin, int *contador1)
{
...
void precioMax(int precio, int *contador2)
{
...
void stockMaxim(int stock, int *contador3)
{
...
void calcularInferior(int precio, int x, int *contador4)
{
    int contador=0;
